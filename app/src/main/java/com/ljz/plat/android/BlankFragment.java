...
public class BlankFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        permissionDialog.showNow(this.getChildFragmentManager(), "BlankFragment");
        this.requestPermissions(new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1000);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        Intent intent = new Intent(ON_REQUEST_PERMISSIONS_RESULT);
        intent.putExtra(GRANT_RESULTS, grantResults);
